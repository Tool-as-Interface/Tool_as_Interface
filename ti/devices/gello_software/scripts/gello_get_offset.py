...
class Args:
    ...
    start_joints: Tuple[float, ...] = (0, -1.57, -1.57, -1.57, 1.57, -3.1415926) #TODO
    ...
    # shelf picking
    # left arm (192.168.0.3): 0, -1.57, 1.57, -1.57, -1.57, 3.1415926
    # right arm (192.168.0.2): 0, -1.57, -1.57, -1.57, 1.57, -3.1415926
