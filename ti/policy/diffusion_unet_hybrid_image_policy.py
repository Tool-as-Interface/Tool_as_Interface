...
from ti.model.common.normalizer import LinearNormalizer
from ti.policy.base_image_policy import BaseImagePolicy
from ti.model.diffusion.conditional_unet1d import ConditionalUnet1D
from ti.model.diffusion.mask_generator import LowdimMaskGenerator
from ti.common.robomimic_config_util import get_robomimic_config
from robomimic.algo import algo_factory
from robomimic.algo.algo import PolicyAlgo
import robomimic.utils.obs_utils as ObsUtils
import robomimic.models.base_nets as rmbn
import robomimic.models.obs_core as rmoc
import ti.model.vision.crop_randomizer as dmvc
from ti.common.pytorch_util import dict_apply, replace_submodules
from ti.model.common.resample import create_named_schedule_sampler, LossAwareSampler
from ti.policy.base_image_policy import apply_conditioning_init
from ti.model.common.nn import mean_flat
from collections import deque
from omegaconf import OmegaConf

from ti.model import *
...
class DiffusionUnetHybridImagePolicy(BaseImagePolicy):
    def __init__(self, 
            ...
            **kwargs):
        super().__init__()
        self.enable_transform_pred = enable_transform_pred
        ...
        for key, attr in obs_shape_meta.items():
            shape = attr['shape']
            if 'tracks' in key or 'vis' in key or attr.get('enabled', True) == False:
                continue
            ...
            if type == 'rgb':
                ...
                obs_config['track'].append(key)
            elif type == 'feature':
                obs_config['feature'].append(key)
            else:
        ...
        encoder_kwargs['rgb']["core_kwargs"]["backbone_kwargs"]['pretrained'] = kwargs.get('pretrained', True) 
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor], vis_tracks=False) -> Dict[str, torch.Tensor]:
        """
        ...
        result.update(vis_dict)  # add visual tracks if enabled
        return result
    ...
    def compute_loss(self, batch, vis=False):
        # normalize input
